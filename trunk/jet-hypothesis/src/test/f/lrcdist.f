...
c
c Copyright (c) James G. MacKinnon, 1998 (corrected 2003-5-05)
c
c lrcdist.f:  This program estimates asymptotic critical values
...
c
      character*1 yesno
c
      write(6,*) 'lrcdist. Copyright James G. MacKinnon, 1998.'
      write(6,*) ' '
c
