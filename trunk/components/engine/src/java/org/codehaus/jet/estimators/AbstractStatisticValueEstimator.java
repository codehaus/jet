...
public abstract class AbstractStatisticValueEstimator implements StatisticValueEstimator {
     ...
     * @param threshold
     */
    public AbstractStatisticValueEstimator(int np, double threshold) {
     ...
     * @param threshold
     */
    public AbstractStatisticValueEstimator(ResponseSurfaceEvaluator responseSurfaceEvaluator, int np, double threshold) {
