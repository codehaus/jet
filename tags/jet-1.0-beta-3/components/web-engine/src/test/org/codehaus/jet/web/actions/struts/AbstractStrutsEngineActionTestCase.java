 ...
 * @author Mauro Talevi
 */
public abstract class AbstractStrutsEngineActionTestCase extends MockObjectTestCase {
    ...
    protected void setTestDir() {
        ...
        if ( testSrcDir == null ){
            testSrcDir = "components/web-engine/src/test/"; 
    ...
    protected HttpServletRequest mockRequestForDefaultMode() {
        Mock mock = mock(HttpServletRequest.class);        
        mock.expects(atLeastOnce()).method("removeAttribute").withAnyArguments();
        return (HttpServletRequest)mock.proxy();
    }
